...
<head>
    ...
    <title>Thêm loại sách mới</title>
    ...
    <main id="test" class="container" style="margin-top: 50px; margin-bottom: 100px;">
        ...
        <div class="row">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                <div class="mb-3">
                    <label for="name_category_add_category" class="form-label">Tên loại sách:</label>
                    <input type="text" name="name_category_add_category" class="form-control"
                        id="name_category_add_category" required>
                </div>
                <button id="btn_add_category_add_category" name="btn_add_category_add_category"
