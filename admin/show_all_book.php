                    ...
                    ?>
                            <tr>
                                ...
                                <td style="width: 170px;">
                                    <button class="btn" id="btn_edit_show_all_book">Sửa</button>
                                    <a href="?delete_book&id_of_book=<?php echo $value[0]; ?>"><button class="btn" id="btn_del_show_all_book" name="btn_del_show_all_book">Xóa</button></a>
                                </td>
                            </tr>
                    <?php $numerical_order++;
                        }
