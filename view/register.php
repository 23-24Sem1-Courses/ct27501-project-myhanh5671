    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center">
            ...
            <li class="breadcrumb-item active" aria-current="page"
                style="color: #ffe020; font-weight: 600; font-size: 16px;">&nbsp;Đăng ký tài khoản</li>
        </ol>
    </nav>
</div>
<main class="container">
    ...
    <div class="row">
        ...
        <form class="col" id="form_register" method="post" action="#"
            style="padding: 20px; box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
            <div id="nav_form_login" class="row border-bottom">
                <div class="col text-center nav_login_register border-end"><a id="switch_login"
                        href="?action=login">Đăng nhập</a></div><!-- bổ sung href  -->
                <div class="col text-center nav_login_register"><a style="color: black; pointer-events: none;"
                        href="#">Đăng ký</a></div>
            </div>
            <div class="my-3">
            ...
            <div class="mb-3">
                ...
                <input type="password" name="password_repeat_register" class="form-control"
