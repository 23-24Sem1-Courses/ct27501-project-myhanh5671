...
<div id="breadcrumb_background">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" style="color: #ffe020; font-weight: 600; font-size: 16px;">&nbsp;Tìm kiếm</li>
        </ol>
    </nav>
</div>
        ...
        <?php if (isset($result_search_book)) {
            foreach ($result_search_book as $value) { ?>
                ...
                <div class="col-md-3 col-6 list_item_search_book">
                    ...
                    <a href="?action=book_details&id_of_book=<?php echo $value['id'] ?>" class="d-block text-center mt-3"><?php echo $value['book_name']; ?></a>
